<?php include "header.php"; ?>		
    ...
    <div class="row mt-3">
      ...
      <<!-- Tambahkan kode JavaScript untuk menangani klik tombol BELI -->
<script>
    // Fungsi untuk menangani klik tombol BELI
    function handleBeliClick(id_film) {
        // Redirect pengguna ke halaman pembelian.php dengan menyertakan ID film
        window.location.href = 'pembelian.php?id_film=' + id_film;
    }
</script>
    ...
    <div class="col-md-4 mt-3" style="margin-bottom: 30px;">
        <div class="card border-dark">
            ...
            <div class="card-body">
                ...
                <!-- Ganti <button> menjadi <a> untuk membuatnya terlihat seperti tautan -->
                <a href="javascript:void(0);" class="btn btn-success btn-sm" onclick="handleBeliClick(<?php echo $result['id_film']; ?>)">BELI</a>
